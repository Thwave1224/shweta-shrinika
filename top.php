...
.sudo11 {
    width: 230px;
    height: 390px;
    background-image: url("./img/504/504-4.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}

.sudo11:hover {
    background-image: url("./img/504/504-5.jpg");
}
...
.sudo4:hover {
    background-image: url("./img/506/506-3.jpg");
}

.sudo7 {
    width: 230px;
    height: 390px;
    background-image: url("./img/507/4.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}
...
<body>
    ...
    <!-- <div class="container dropdown-div">
                ...
                <div class="list2">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="option1">
                            Kurta & Kurtis <span class="sp1">11</span>
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option2">
                        <label class="form-check-label" for="option2">
                            Dresses <span class="sp2">7 </span>
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option2">
                        <label class="form-check-label" for="option2">
                            Tops <span class="sp8">5</span>
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option2">
                        <label class="form-check-label" for="option2">
                            Top & Bottom Sets <span class="sp9">2</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div id="Demo2" class="w3-dropdown-content w3-bar-block w3-border">
                <div class="list2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option5">
                        <label class="form-check-label" for="option5">
                            XXL <span class="sp6">25</span>
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option5">
                        <label class="form-check-label" for="option5">
                            XXXL <span class="sp7">22</span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="dropdown-click">
            <button onclick="myFunction4()" class=" w3-light-gray box"><i class="fa-solid fa-bars"></i> Short :
                Popularity
            </button>
