...
<!-- ................... section .................................. -->
 ...
 <div class="not">
    <p class="found">Terms of service</p>
    <p class="wel">refers to SHRINIKA. The information on the website, tools and services is for the users. Browsing through the website means the user has accepted the terms, conditions, notices and policies of the website. Visiting or purchasing from the website means you are bound to the terms and conditions. The terms apply to all the vendors, browsers, merchants, content contributors and customers.
  ...
  <h3 class="hed">Section-1 Online Store Terms</h3>
  <p class="wel">
  You have to be a major to agree to the terms and conditions. With your consent, dependents can also use the website. Our products cannot be used illegally or for unauthorized purposes. Our services cannot be used to violate the laws in your jurisdiction. Any type of destructive virus, worm or code cannot be transmitted by you.
  Violation or breach of any of the terms and conditions may lead to termination of your services.
  </p>

  <h3  class="hed"> Section-2  General Conditions</h3>
  <p class="wel">
  Without prior permission, you cannot duplicate, sell, copy or resell any information on the website.
  We reserve the rules to deny service to anyone at any time for any reason.
  </p>

  <h3  class="hed">Section-3 Accuracy, Completeness and Timeliness Of Information</h3>
  <P class="wel">
  If the information provided on the website is not accurate we are not responsible. It is always better to re-confirm the information and then take decisions to avoid risks.
  </P>

  <h3  class="hed">Section 4 – Modifications To The Service And Prices</h3>
  <p class="wel">
  ...
  <h3  class="hed">Section 5 – Products Or Services</h3>

  <p class="wel">
  The products and services may have limited quantities subject to the stock available. The display on the website may not accurately display the product colour. Return or exchange is subjected to our return or exchange policy. We do not give a warranty that our products, services and information can meet your expectations.
  </p>
 </div>
 ...
 <div class="footer">
    <div class="logo1">
      ...
      <div style="display: flex; justify-content: center;  margin-top: 20px;margin-right: 90px;">
