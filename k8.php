  ...
  <style>
    * {
    ...
    .sudo {
      ...
      background-image: url("./img/501/A.jpg");
    ...
    .sudo1 {
      ...
      height: 390px;
      margin: 20px 0px 20px 12px;
      background-image: url("./img/507/1.jpg");
      background-size: cover;
      transition: background-image 0.3s ease-in-out;
    }

    .sudo1:hover {
      background-image: url("./img/507/5.jpg");
    }
    ...
    .sudo2 {
      ...
      height: 390px;
      margin: 20px 0px 20px 12px;
      background-image: url("./img/503/503-16.jpg");
      background-size: cover;
      transition: background-image 0.3s ease-in-out;
    }

    .sudo2:hover {
      background-image: url("./img/503/503-17.jpg");
    }
    ...
    <div class="product-container">
      <div class="image-gallery">
        <div class="small-images">
          <img src="./img/506//506-1.jpg" alt="Small Image 1" class="small-img" onclick="changeImage(this)" />
          <img src="./img/506/506-2.jpg" alt="Small Image 2" class="small-img" onclick="changeImage(this)" />
          <img src="./img/506/506-3.jpg" alt="Small Image 3" class="small-img" onclick="changeImage(this)" />
          <img src="./img/506/506-7.jpg" alt="Small Image 4" class="small-img" onclick="changeImage(this)" />
        </div>
        <div class="main-image">
          <img src="./img/506/506-4.jpg" alt="Main Product Image" id="main-img" data-zoom-image="./img/506/4.jpg" />
        </div>
      </div>
