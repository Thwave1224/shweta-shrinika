...
<head>
    ...
    <title>Buy S SHRINIKA products online at best prices on shrinikachoice.com</title>
...
<body>
    ...
    <!-- ============================================= TOP  ======================================================================== -->
    <h2 class="title13">GOWNS & DRESSES</h2>
<!-- 
                ...
                <div class="list2">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="option3">
                            Kurta & Kurtis <span class="sp1">1</span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="dropdown-click">
            ...
            <div id="Demo4" class="w3-dropdown-content w3-bar-block w3-border">
                <div class="list">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option1" />
                        <label class="form-check-label" for="option1"> 0 - 200 </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option2" />
                        <label class="form-check-label" for="option2"> 200 - 500 </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option3" />
                        <label class="form-check-label" for="option3"> 500 - 1000 </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="option4" />
                        <label class="form-check-label" for="option4">
