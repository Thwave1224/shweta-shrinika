  ...
  <style>
    * {
    ...
    .sudo {
      ...
      background-image: url("./img/511/1.jpg");
      background-size: cover;
      transition: background-image 0.3s ease-in-out;
    }

    .sudo:hover {
      background-image: url("./img/511/4.jpg");
    }
    ...
    .sudo1 {
      ...
      height: 390px;
      margin: 20px 0px 20px 12px;
      background-image: url("./img/512/1.jpg");
      background-size: cover;
      transition: background-image 0.3s ease-in-out;
    }

    .sudo1:hover {
      background-image: url("./img/512/3.jpg");
    }
    ...
    .sudo2 {
      ...
      height: 390px;
      margin: 20px 0px 20px 12px;
      background-image: url("./img/514/1.jpg");
      background-size: cover;
      transition: background-image 0.3s ease-in-out;
    }

    .sudo2:hover {
      background-image: url("./img/514/3.jpg");
    }
    ...
    <div class="product-container">
      <div class="image-gallery">
        <div class="small-images">
          <img src="./img/502/5.jpg" alt="Small Image 1" class="small-img" onclick="changeImage(this)" />
          <img src="./img/502/1.jpg" alt="Small Image 2" class="small-img" onclick="changeImage(this)" />
          <img src="./img/502/2.jpg" alt="Small Image 3" class="small-img" onclick="changeImage(this)" />
          <img src="./img/502/3.jpg" alt="Small Image 4" class="small-img" onclick="changeImage(this)" />
        </div>
        <div class="main-image">
          <img src="./img/502/4.jpg" alt="Main Product Image" id="main-img" data-zoom-image="./img/502/4.jpg" />
        </div>
      </div>
