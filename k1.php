...
<head>
    ...
    * {
    ...
    @media screen and (max-width: 1440px) {
     ...
     /* Media query for mobile view size 320px */
...
<body>
        ...
        <div class="product-container">
            <div class="image-gallery">
                <div class="small-images">
                    <img src="./img/501/1.jpg" alt="Small Image 1" class="small-img" onclick="changeImage(this)" />
                    <img src="./img/501/3.jpg" alt="Small Image 2" class="small-img" onclick="changeImage(this)" />
                    <img src="./img/501/5.jpg" alt="Small Image 3" class="small-img" onclick="changeImage(this)" />
                    <img src="./img/501/22.jpg" alt="Small Image 4" class="small-img" onclick="changeImage(this)" />
                </div>
                <div class="main-image">
                    <img src="./img/501/44.jpg" alt="Main Product Image" id="main-img"
                        data-zoom-image="./img/501/44.jpg" />
                </div>
            </div>
                    ...
                    <div id="popup" class="popup">
                        <div class="popup-content">
                            ...
                            <div id="popupButtons">
                                ...
                                <button id="addToCartAction" class="btn" onclick="openForm('form3')">Add to
                                    Cart</button>
                            </div>
                        </div>
                    </div>
    ...
    <div id="addToBagModal" class="modal">
        <div class="modal-content">
            ...
            <h2 class="cl" style="font-size: 19px; font-family:  sans-serif; letter-spacing: 1px;">Select Preference
            </h2>
    ...
    $(document).ready(function() {
        $(".top-slider .slides").slick({
            ...
            slidesToShow: 4,
            slidesToScroll: 1,
            asNavFor: ".middle-slider .slides, .bottom-slider .slides, .three-slide-slider .slides",
            responsive: [{
                    breakpoint: 768,
                    settings: {
                        slidesToShow: 2,
        ...
        $(".middle-slider .slides").slick({
            ...
            slidesToShow: 3,
            slidesToScroll: 1,
            asNavFor: ".top-slider .slides, .bottom-slider .slides, .three-slide-slider .slides",
            responsive: [{
                breakpoint: 425,
                settings: {
                    slidesToShow: 2,
        ...
        $(".three-slide-slider .slides").slick({
            ...
            slidesToShow: 2,
            slidesToScroll: 1,
            asNavFor: ".top-slider .slides, .bottom-slider .slides, .middle-slider .slides",
            responsive: [{
                breakpoint: 425,
                settings: {
                    slidesToShow: 1,
        ...
        $(".bottom-slider .slides").slick({
            ...
            slidesToShow: 1,
            slidesToScroll: 1,
            asNavFor: ".top-slider .slides, .middle-slider .slides, .three-slide-slider .slides",
        });
    });
    </script>
        ...
        <div class="div12">
            ...
            <div class="css-9erq78">
                ...
                <p data-sd-event="" class="css-zw6a4m">
                    ...
                    same as the pho to they have shown. Its so comfortable, <br />
