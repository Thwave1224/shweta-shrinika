...
.sudo3 {
    width: 230px;
    height: 390px;
    background-image: url("./img/504/1.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}
...
.sudo5 {
    width: 230px;
    height: 390px;
    background-image: url("./img/508/1.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}

.sudo5:hover {
    background-image: url("./img/508/4.jpg");
}

.sudo6 {
    width: 230px;
    height: 390px;
    background-image: url("./img/509/1.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}

.sudo6:hover {
    background-image: url("./img/509/2.jpg");
}

.sudo8 {
    width: 230px;
    height: 390px;
    background-image: url("./img/510/1.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}

.sudo8:hover {
    background-image: url("./img/510/2.jpg");
}
...
.sudo9:hover {
    background-image: url("./img/511/3.jpg");
}

.sudo10 {
    width: 230px;
    height: 390px;
    background-image: url("./img/512/11.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}

.sudo10:hover {
    background-image: url("./img/512/12.jpg");
}
...
.sudo12:hover {
    background-image: url("./img/514/5.jpg");
}
...
.sudo14 {
    width: 230px;
    height: 390px;
    background-image: url("./img/509/13.jpg");
    background-size: cover;
    transition: background-image 0.3s ease-in-out;
}

.sudo14:hover {
    background-image: url("./img/509/14.jpg");
}
...
.sudo15:hover {
    background-image: url("./img/506/506-5.jpg");
}
...
<body>
    ...
    <!-- ======================================= NAYRA KURTI ============================================================================== -->
    <h2 class="title12">NYRA KURTI</h2>
    ...
    <div class="dropdown-click">
      <button onclick="myFunction()" class=" w3-light-gray box">Product Type <i
      ...
      <div id="Demo" class="w3-dropdown-content w3-bar-block w3-border">
        <div class="list2">
          <div class="form-check">
            ...
            <abel class="form-check-label" for="option1">
              Kurta & Kurtis <span class="sp1">17</span>
              </label>
          ...
          <div class="form-check">
            ...
            <label class="form-check-label" for="option2">
              Dresses <span class="sp2">15</span>
            </label>
          </div>
        </div>
      </div>
    ...
    <div class="dropdown-click">
      <button onclick="myFunction1()" class=" w3-light-gray box">Size <i
          class="fa-solid fa-chevron-up fa-flip-vertical"></i></button>
      <div id="Demo2" class="w3-dropdown-content w3-bar-block w3-border">
        <div class="list2">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="" id="option5">
            <label class="form-check-label" for="option5">
              XXL <span class="sp6">32</span>
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="" id="option5">
            <label class="form-check-label" for="option5">
              XXXL <span class="sp7">31</span>
            </label>
          </div>
        </div>
      </div>
    ...
    <div class="dropdown-click">
      <button onclick="myFunction2()" class=" w3-light-gray box">Colour <i
          class="fa-solid fa-chevron-up fa-flip-vertical"></i></button>
      <div id="Demo3" class="w3-dropdown-content w3-bar-block w3-border">
        <div class="list">
          <div class="css-19qfdfr">
            ...
            <p data-sd-event="" class="css-tw8l5q">6</p>
          </div>
          ...
          <div class="css-19qfdfr">
            <div class="css-lwshl4">
              <input type="checkbox" class="css-1iqa3sw" value="">
              <label>
                <p data-sd-event="" class="css-5x1nvx">Black & White</p>
              </label>
            </div>
            <p data-sd-event="" class="css-tw8l5q">1</p>
          </div>
    ...
    <div class="dropdown-click">
      <button onclick="myFunction3()" class=" w3-light-gray box">Price Range <i
          class="fa-solid fa-chevron-up fa-flip-vertical"></i></button>
      <div id="Demo4" class="w3-dropdown-content w3-bar-block w3-border">
        <div class="list">
          ...
          <div class="css-19qfdfr">
            ...
            <p data-sd-event="" class="css-tw8l5q">25</p>
          </div>
          ...
          <div class="css-19qfdfr">
            <div class="css-lwshl4">
              <input type="checkbox" class="css-1iqa3sw" value="">
              <label>
                <p data-sd-event="" class="css-5x1nvx">5000 - 10000</p>
              </label>
            </div>
            <p data-sd-event="" class="css-tw8l5q">0</p>
          </div>
    ...
    <div class="dropdown-click">
      <button onclick="myFunction4()" class="w3-light-gray box"><i class="fa-solid fa-bars"></i> Short : Popularity
      </button>
  ...
  <script>
    ...
    <section class="section2">
        ...
        <div class="card"
            style="width: 17rem;padding-left: 20px; padding-right: 25px; border: none;cursor: pointer; margin: 15px; ">
            ...
            <div class="card-body">
                ...
                <div class="css-5bhc30">
                    ...
                    <button class="btn1" onclick="openForm('form3')" name="button">ADD TO BAG</button>
                </div>
            </div>
        </div>

        <div class="card"
            style="width: 17rem; border: none;padding-left: 20px; padding-right: 25px; cursor:pointer; margin: 20px;">
            <svg width="17" height="17" viewBox="0 0 20 20" fill="var(--grey1)" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="m3.593 17.432 7.232-2.584c1.104-.392 1.424-1.808.592-2.64L7.793 8.584a1.602 1.602 0 0 0-2.64.592l-2.584 7.232a.801.801 0 0 0 1.024 1.024zM12.449 10l4.048-4.048a1 1 0 0 1 1.416 0L17.96 6a.604.604 0 0 0 .848 0 .604.604 0 0 0 0-.848l-.048-.048a2.207 2.207 0 0 0-3.112 0L11.6 9.152a.604.604 0 0 0 0 .848.604.604 0 0 0 .848 0zM8.449 5.904l-.048.048a.604.604 0 0 0 0 .848.604.604 0 0 0 .848 0l.048-.048a2.207 2.207 0 0 0 0-3.112l-.04-.04a.604.604 0 0 0-.856.848l.048.048a1.004 1.004 0 0 1 0 1.408zM14.05 9.905l-.849.848a.604.604 0 0 0 0 .848.604.604 0 0 0 .848 0l.848-.848a1 1 0 0 1 1.416 0l.864.864a.604.604 0 0 0 .848 0 .604.604 0 0 0 0-.848l-.864-.864a2.207 2.207 0 0 0-3.112 0zM12.45 5.104 10 7.552a.604.604 0 0 0 0 .848.604.604 0 0 0 .848 0l2.448-2.448a2.207 2.207 0 0 0 0-3.112l-.848-.848a.604.604 0 0 0-.848 0 .604.604 0 0 0 0 .848l.848.848a1.014 1.014 0 0 1 0 1.416z"
                    fill="var(--grey1)"></path>
...
<div id="form3" class="modal fade">
    <!-- ... -->
    <div class="modal-body">
        <select name="test1" id="size-select">
            <option value="XS">XS</option>
            <option value="S">S</option>
            <option value="M">M</option>
            <option value="L">L</option>
    ...
    <button id="submit" onclick="addToBag()" class="button">ADD TO BAG</button>
</div>
...
<script>
  function addToBag() {
    ...
    p.className = "add2";
    p.textContent = "Wain Printed Kurti For Women";

    var span = document.createElement("span");
    span.textContent = `(${size}) 2* ₹449`;

    // Add the item content to the item element
    item.appendChild(img);
    item.appendChild(p);
    item.appendChild(span);

    // Add the item to the bag items container
    document.getElementById("bag-items").appendChild(item);

    // Open the second popup menu
    openForm('form4');
