        ...
        <style>
            * {
            ...
            .sudo1 {
                ...
                height: 390px;
                margin: 20px 0px 20px 12px;
                background-image: url("img/513/1.jpg");
                background-size: cover;
                transition: background-image 0.3s ease-in-out;
            }

            .sudo1:hover {
                background-image: url("./img/513/6.jpg");
            }
            ...
            <div class="product-container">
                <div class="image-gallery">
                    <div class="small-images">
                        <img src="./img/504/1.jpg" alt="Small Image 1" class="small-img" onclick="changeImage(this)" />
                        <img src="./img/504/504-1.jpg" alt="Small Image 2" class="small-img"
                            onclick="changeImage(this)" />
                        <img src="./img/504/504-2.jpg" alt="Small Image 3" class="small-img"
                            onclick="changeImage(this)" />
                        <img src="./img/504/504-4.jpg" alt="Small Image 4" class="small-img"
                            onclick="changeImage(this)" />
                    </div>
                    <div class="main-image">
                        <img src="./img/504/504-3.jpg" alt="Main Product Image" id="main-img"
                            data-zoom-image="./img/504/504-3.jpg" />
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="add">
                        ...
                        <a href="index.php" class="test4"> <img src="./img/503/503-1.jpg" alt="" class="add1"
                                width="70">
