  ...
  <div class="container3">
    ...
    <div class="image-gallery">
        <div class="small-images">
          <img src="./img/507/1.jpg" alt="Small Image 1" class="small-img" onclick="changeImage(this)" />
          <img src="./img/507/2.jpg" alt="Small Image 2" class="small-img" onclick="changeImage(this)" />
          <img src="./img/507/3.jpg" alt="Small Image 3" class="small-img" onclick="changeImage(this)" />
          <img src="./img/507/4.jpg" alt="Small Image 4" class="small-img" onclick="changeImage(this)" />
        </div>
        <div class="main-image">
          <img src="./img/507/5.jpg" alt="Main Product Image" id="main-img" data-zoom-image="./img/507/5.jpg" />
        </div>
      </div> 
