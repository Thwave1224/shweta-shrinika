...
<body>
    ...
    <div class="not">
        <p class="found">Return policy</p>
        <b class="bold">Return and Refund Policy</b>
        <h3 class="hed">Cancellation Policy:</h3>

        <ul class="demo1">
            <li> In case there is an order cancellation, please do so before it is shipped. Once the product is
                shipped
                it can not be cancelled using our website</li>
        </ul>
        <h3 class="hed1">Return Policy:</h3>
        <Ul class="demo1">
            <li> Return/Exchange is available for selected products only, the return information is available on the
                product page on the website. The return policy of a product.</li>
            <li> In case we do not have pick up service available at your location, you would have to self-ship the
                product to our office Address.</li>
            <li> Return/Exchange charges may apply on case to case basis.</li>
        </Ul>

        <h3 class="hed"> NOTE FOR RETURN</h3>

        <Ul class="demo1">
            <li> → The items should be unused and unwashed for hygiene reasons.</li>
            <li> → The product should have the original packaging and tags in place. Items without the original tags
                will not be accepted.</li>
            <li> → Customized products cannot be returned or exchanged</li>
            <li> → Return/Exchange requests that are not raised within the return period (Refer product page) the
                product would not be accepted.</li>
        </Ul>
    </div>
