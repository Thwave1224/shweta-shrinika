        ...
        <div class="product-container">
            <div class="image-gallery">
                <div class="small-images">
                    <img src="./img/508/1.jpg" alt="Small Image 1" class="small-img" onclick="changeImage(this)" />
                    <img src="./img/508/2.jpg" alt="Small Image 2" class="small-img" onclick="changeImage(this)" />
                    <img src="./img/508/3.jpg" alt="Small Image 3" class="small-img" onclick="changeImage(this)" />
                    <img src="./img/508/4.jpg" alt="Small Image 4" class="small-img" onclick="changeImage(this)" />
                </div>
                <div class="main-image">
                    <img src="./img/508/5.jpg" alt="Main Product Image" id="main-img"
                        data-zoom-image="./img/508/5.jpg" />
                </div>
            </div>
