...
textarea:focus {
  ...
  <body>
    ...
    <!-- <div class="top-nav">
      <div>Shrinika Choice</div>
      <div class="user-icon"><img src="/img/1-png-removebg-preview.png" alt="" style="height: 200px;"></div>
    </div> -->

    <div class="content">
      <div class="main-content">
        <div class="hi">
          <h1 class="my-4">Colours</h1>
        <form class="mb-4">
          <div class="mb-3">
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Lavender</td>
                <td>Description of the colour </td>
                <td>
